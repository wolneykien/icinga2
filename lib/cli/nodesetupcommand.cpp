	...
	boost::program_options::options_description& hiddenDesc) const
{
	visibleDesc.add_options()
		...
		("global_zones", po::value<std::vector<std::string> >(), "The names of the additional global zones to 'global-templates', 'global-commands' and 'director-global'.")
...
int NodeSetupCommand::SetupMaster(const boost::program_options::variables_map& vm, const std::vector<std::string>& ap)
{
	...
	std::vector<String> globalZones { "global-templates", "global-commands", "director-global" };
